...
<center><pre style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif ; font-size: 40px; margin-top: 13px;">                                    Welcome to Vintage Books</pre></center>
<center><pre style="font-size: 18px; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif ;margin-top: 2px;position: ;background-position-y:top ;">                                                                                                              -----Your Gateway to Preloved Literary Treasures!</pre>
</center>
    ...
    <h3>Discover a world of captivating stories, hidden within the pages of gently used books. At Vintage Books, we are passionate about connecting book lovers and providing a platform for the exchange of cherished tales. Whether you're seeking a beloved classic, a rare edition, or simply looking to declutter your bookshelf, our virtual marketplace is the ideal destination.</h3>
    <div class="intro"><h2 style="color:green;"><img src="why.png"> Why Vintage Books?</h2>
    ...
    <div class="introduction">    <h4>Connect with Fellow Bibliophiles:</h4> <i>Vintage Books is more than just a marketplace; it's a thriving community of book enthusiasts. Engage in lively discussions, share recommendations, and interact with like-minded readers who share your passion for the written word.</i>
...
<h4>Secure Transactions:</h4><i> Rest assured that your transactions are protected on Vintage Books. We prioritize your safety and privacy, implementing robust security measures to ensure a seamless and trustworthy shopping experience.</i><br><br></div>
    <div class="foot"><footer>
    Join Vintage Books today and embark on a literary adventure like no other. Uncover hidden treasures, forge meaningful connections, and breathe new life into stories waiting to be discovered. Let the pages turn and the magic unfold as you delve into the captivating world of preloved books.<br>
